...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 border-r border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-700 pt-6 pr-4 pb-6 pl-4">
                ...
                {section.items.map((item) => (
                  <Link
                    ...
                    className={cn(
                      ...
                      sectionIndex === 1
                        ? "gap-2 h-14 rounded-2.5xl p-3 border border-design-line-light-gray dark:border-design-dark-line-light-gray text-design-main-text dark:text-design-dark-main-text font-normal hover:bg-gray-50 dark:hover:bg-gray-800"
                        : "gap-1 h-11 rounded-2.5xl p-3",
                      // 第一组和第三组的选中效果
